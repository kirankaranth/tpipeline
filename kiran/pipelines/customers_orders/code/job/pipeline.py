...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "3252/pipelines/customers_orders")
    MetricsCollector.start(spark = spark, pipelineId = "3252/pipelines/customers_orders")
    pipeline(spark)
