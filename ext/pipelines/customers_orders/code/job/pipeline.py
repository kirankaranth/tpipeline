...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "355/pipelines/customers_orders")
    MetricsCollector.start(spark = spark, pipelineId = "355/pipelines/customers_orders")
    pipeline(spark)
