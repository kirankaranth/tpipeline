...
def Join_PKT_2(spark: SparkSession, met_collectiviteit_rgl: DataFrame, laatst_vijf_jaar: DataFrame, ) -> DataFrame:
    return met_collectiviteit_rgl\
        ...
        .join(
          ...
          (
            ...
            & (
              (coalesce(col("met_collectiviteit_rgl.INGANG_DTM"), lit("0001-01-01").cast(DateType())) < coalesce(col("laatst_vijf_jaar.INGANG_DTM"), lit("0001-01-01").cast(DateType())))
              & (
